...
class MessageManagerTest
{
    ...
    {
        assertEquals( colorize( "&aHello &bWorld&e!" ),
                      colorChar + "aHello " + colorChar + "bWorld" + colorChar + "e!" );
    }
    ...
    {
        assertEquals( replaceVariables( "I am from {state}.", new String[]{ "{state}", "California" } ),
    ...
    {
        assertEquals( replaceVariables( "I am from {state} and my mother is from {state}.",
                                        new String[]{ "{state}", "California" } ),
                      "I am from California and my mother is from California." );
    }
    ...
    {
        assertEquals( replaceVariables( "!{car}:{element}#{element}*{car}({color}",
                                        new String[]{ "{car}", "Tesla", "{element}", "Fire", "{color}", "purple" } ),
                      "!Tesla:Fire#Fire*Tesla(purple" );
    }
